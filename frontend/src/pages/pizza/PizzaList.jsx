      ...
      <div className="mb-8 space-y-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold text-slate-900 sm:text-3xl">Pizza Menu</h1>
            <p className="mt-2 text-slate-600 max-w-2xl">Search, filter and order from our freshest pizzas.</p>
          </div>
          <div className="filters-stack hidden md:grid">
            <input
              value={searchText}
        ...
        <div className="flex w-full min-w-0 flex-col gap-3 md:hidden">
          <input
            ...
            className="mobile-search-bar w-full"
          />
          <button
            type="button"
            onClick={() => setShowFilters(true)}
            className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-slate-100 px-3 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-200"
          >
            Filters & sort
          </button>
        </div>
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3">
          <button
            type="button"
            onClick={() => setShowFilters(true)}
            className="hidden items-center gap-2 rounded-full bg-slate-100 px-3 py-2 text-sm text-slate-700 hover:bg-slate-200 md:inline-flex"
          >
            Filters
          </button>
          <button
