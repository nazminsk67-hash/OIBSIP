            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
                <select
                  ...
                  className="w-full min-w-0 rounded-lg border border-current border-opacity-20 bg-white bg-opacity-50 px-3 py-2.5 text-sm font-medium transition disabled:opacity-50 sm:w-auto"
                >
