  ...
  return (
    <div className="page-shell space-y-8">
      <div className="space-y-3">
        ...
        <h1 className="text-2xl font-semibold sm:text-3xl" style={{ color: 'var(--text-primary)' }}>Analytics overview</h1>
      ...
      {isFirstLoad ? (
        ...
        <>
          ...
          <div className="grid-dashboard-split">
            <section className="chart-panel rounded-[2rem] border p-4 sm:p-6 shadow-sm" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
              ...
              <div className="chart-height w-full">
                {recharts ? (
          ...
          <div className="grid-dashboard-split">
            <section className="min-w-0 rounded-[2rem] border p-4 sm:p-6 shadow-sm" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
