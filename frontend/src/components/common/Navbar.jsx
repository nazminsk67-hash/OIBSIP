    ...
    <nav role="navigation" aria-label="Main navigation" className="bg-white border-b border-gray-100 sticky top-0 z-40 dark:bg-slate-900 dark:border-slate-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Logo */}
          <Link to={isAdmin ? '/admin/analytics' : '/pizzas'} className="flex items-center gap-2">
          ...
          {isAuthenticated && (
            <div className="flex items-center gap-6">
              {!isAdmin && (
                <>
                  <Link to="/pizzas"  className="text-sm text-gray-600 dark:text-slate-300 hover:text-primary-500 transition-colors">Menu</Link>
              ...
              {isAdmin && (
                <>
                  <Link to="/admin/analytics" className="text-sm text-gray-600 dark:text-slate-300 hover:text-primary-500 transition-colors">Analytics</Link>
